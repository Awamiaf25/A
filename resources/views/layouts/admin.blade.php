...
<body dir="rtl">
    ...
    <main role="main" class="pb-3">
        <div class="row-sm-5 row-md-5">
            <div class="col-sm-5 clo-md-5 d-flex align-items-center justify-content-center">
                        ...
                        <ul class="list">
                            <li class="sidebar-user-panel active">
                                ...
                                <div class="profile-usertitle">
                                    <div class="sidebar-userpic-name"> عفيفة العوامي  </div>
